...
;
;
; CRC table used by XMODEM send and receive.
;
; Those programs use indexed lookups which require these table to be
; page aligned. 
;
; There is a *= $C000 located in the sbc.asm file to ensure this is met.
;
; lo CRC lookup table
Crclo
