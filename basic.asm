...
; set-up start values
      ...
      STY   Bpntrl            ; set BASIC execute pointer low byte
      STY   Bpntrh            ; set BASIC execute pointer high byte
...
PG2_TABS
      ...
      .word Serial_Scan       ; non halting key input -   monitor to set this
      .word Serial_Output     ; output vector         -   monitor to set this
      .word Pload             ; load vector           -   monitor to set this
      .word Psave             ; save vector           -   monitor to set this
PG2_TABE
